...
<div id="system">
	...
	<h1 class="title page-heading"><?php echo $this->escape($this->params->get('page_heading')); ?></h1>
	<?php endif; ?>
	...
	<article class="item"<?php if ($view != 'article') printf(' data-permalink="%s"', JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catslug), true, -1)); ?>>
		...
		<header class="article-header">
			...
			<h1 class="title article-heading"><?php echo $this->escape($this->item->title); ?></h1>
			...
			<p class="meta">
				...
				<?php
					...
					if ($params->get('show_create_date')) {
						echo '<time class="skin-calendar" datetime="'.substr($this->item->created, 0,10).'" pubdate>'.JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC5')).'</time>';
					}
