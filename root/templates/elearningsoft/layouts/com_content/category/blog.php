...
<div id="system" class="blog-roll">

	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1 class="title page-header"><?php echo $this->escape($this->params->get('page_heading')); ?></h1>
	<?php endif; ?>

	<?php if ($this->params->get('page_subheading')) : ?>
	<h2 class="subtitle page-subheader"><?php echo $this->escape($this->params->get('page_subheading')); ?></h2>
	<?php endif; ?>

	<?php if ($this->params->get('show_category_title', 1)) : ?>
	<h1 class="title category-title"><?php echo $this->category->title;?></h1>
	<?php endif; ?>
