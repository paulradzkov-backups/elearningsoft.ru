...
<form id="searchbox-<?php echo $module->id; ?>" class="searchbox" action="<?php echo JRoute::_('index.php'); ?>" method="post" role="search">
	<div id="searchbox-line">
		<input type="text" value="" name="searchword" placeholder="<?php echo $label; ?>" class="search-query" />
		<button class="button" type="submit" onclick="this.form.searchword.focus();"><?php echo $button_text; ?></button>
		<button class="button reset-button" type="reset" value="Reset">×</button>
	</div>
