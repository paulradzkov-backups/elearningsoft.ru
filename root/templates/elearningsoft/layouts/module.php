...
if ($module->position == 'shortmenu') {
	$style = 'raw';
    $showtitle = 0;
}
if ($module->position == 'sitemap') {
	$style = 'raw';
    $showtitle = 0;
}
//hard-coded mod_jlms_menu
if (($module->position == 'sitemap') and ($module->id == 113)) {
	$style = 'box';
    $showtitle = 1;
}
//hard-coded mod_jlms_courses
if (($module->position == 'sitemap') and ($module->id == 114)) {
	$style = 'box';
    $showtitle = 1;
}
