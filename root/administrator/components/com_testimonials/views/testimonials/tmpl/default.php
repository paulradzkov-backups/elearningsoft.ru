				  	...
				  	<table border="1" cellpadding="5" width="100%" class="thank_tabl">
						<tr>
							<th colspan="2" class="thank_ftd">
								<strong>
									<img src="<?php echo JURI::root();?>/administrator/components/com_testimonials/assets/images/tick.png" />Say your "Thank you" to Joomla community for WonderFull Joomla CMS
								</strong>
							</th>
						</tr>					
						<tr>
