            ...
            <div class="tab-content">
                <div class="tab-pane" id="topic-details">
                    <fieldset class="adminform">
                        ...
                        <br style="clear:both;"/>
                        <div class="control-group form-inline"><?php echo $this->form->getLabel('author_description'); ?><br /><br />
                            <?php echo $this->form->getInput('author_description'); ?></div>
                        <br style="clear:both;"/>
                        <div class="control-group form-inline"><?php echo $this->form->getLabel('testimonial'); ?><br /><br />
                            <?php echo $this->form->getInput('testimonial'); ?></div>
                </div>
					...
					<?php
						...
						if (file_exists($path) && is_file($path))
						{
							...
							if ($isimage)
							{
								...
								<div style="text-align:center;">
									<img class="ti_photo" src="<?php echo JURI::root().'index.php?option=com_testimonials&task=showpicture&image='.$photo.'&width=114';?>" alt="<?php echo $this->item->t_author;?>" />
								</div>
								<?php
							}
						}
						...
						if ($this->settings->get('use_cb') && isset($this->avatar))
						{
							...
							if (file_exists($path) && is_file($path))
							{
								...
								<div style="text-align:center;">
									<img class="cb_photo ti_photo" src="<?php echo JURI::root().'index.php?option=com_testimonials&task=showpicture&image=images/comprofiler/'.$this->avatar.'&width=114';?>" alt="<?php echo $this->avatar;?>" />
								</div>
								<?php
							}
						}
						...
						if ($this->settings->get('use_jsoc') && isset($this->avatar))
						{
							...
							if (file_exists($path) && is_file($path))
							{
								...
								<div style="text-align:center;">
									<img class="js_photo ti_photo" src="<?php echo JURI::root().'index.php?option=com_testimonials&task=showpicture&image='.$this->avatar.'&width=114';?>" alt="<?php echo $this->avatar;?>" />
								</div>
								<?php
							}
						}
