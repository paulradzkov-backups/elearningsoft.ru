            ...
            <div class="nav-collapse-joomlaquiz nav-collapse collapse">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="drop-testimonials-management">
                        <li class="dropdown"><a href="index.php?option=com_testimonials&view=topics" role="button" class="dropdown-toggle"><?php echo JText::_('COM_TESTIMONIALS_SUBMENU_TOPICS');?></a></li>
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?option=com_testimonials&view=templates"><?php echo JText::_('COM_TESTIMONIALS_SUBMENU_TEMPL');?></a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="drop-questions-manage">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?option=com_testimonials&task=reset_templ"><?php echo JText::_('COM_TESTIMONIALS_ADMINISTRATION_RESET_TEMPLATES');?></a></li>
                    </ul>
                </li>
				
				<li class="dropdown">
					<a href="#" id="drop-settings" role="button" class="dropdown-toggle" data-toggle="dropdown"><?php echo  JText::_('COM_TESTIMONIALS_MENU_SETTINGS') ?><b class="caret"></b></a>
					<ul class="dropdown-menu" role="menu" aria-labelledby="drop-settings">
						<li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?option=com_config&view=component&component=com_testimonials&return=<?php echo urlencode(base64_encode((string)JUri::getInstance())) ?>"><?php echo JText::_('COM_TESTIMONIALS_SUBMENU_SETTINGS')?></a></li>
